...
- `assets/CV_JinXie_20260907.pdf`：2026-09-07 更新的英文简历，对应导航栏 CV 和个人介绍区 Curriculum Vitae 链接。
- `assets/CV_JinXie_zh_20260907.pdf`：2026-09-07 更新的中文简历，对应导航栏和个人介绍区的独立“中文简历”链接。替换文件名时，同步修改 `index.html` 中对应语言的两个链接。
...
- 2026-09-07 用户提供的英文简历 `CV20260907.pdf` 和更正后的中文简历 `CV20260907中文.pdf`（当前中英文 CV，原样发布）。
